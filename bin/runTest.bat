...
set LOG4JOPTS=-Dlog4j.configuration="file:///c:\tnt\build\tnt4j-streams-ibm-b2bi\tnt4j-streams-ibm-b2bi-1.0.10-SNAPSHOT\config\log4j.properties"
...
set STREAMSOPTS=%STREAMSOPTS% %LOG4JOPTS% %TNT4JOPTS% %EVENTS_DIR% %PARSER_CONFIG% -Dtest=true
